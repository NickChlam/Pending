...
export class PendEditComponent implements OnInit{

  @Output() pendingChange: EventEmitter<any> = new EventEmitter();
  closeResult: string;
  pendForm: FormGroup;
  employees = [];
  user;
  ...
  ngOnInit() {
    ...
    // console.log(this.edit.cand)
    // this.AddCandidateTest(this.edit.cand);
